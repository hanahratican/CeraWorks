  ...
  return (
    <div name='home' className='w-full h-screen bg-neutral-200'>
        ...
        <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
            ...
            <p className='text-zinc-600 py-4 max-w-[700px]'>CeraWorks serves the San Diego area by providing top quality auto detailing and ceramic paint protections services.
